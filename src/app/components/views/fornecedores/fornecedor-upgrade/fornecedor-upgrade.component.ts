...
@Component({
  selector: 'app-fornecedor-upgrade',
  templateUrl: './fornecedor-upgrade.component.html',
  styleUrls: ['./fornecedor-upgrade.component.css']
})
export class FornecedorUpgradeComponent implements OnInit {
  ...
  update() {
    this.service.updateFornecedor(this.fornecedor).subscribe(element => {
      this.service.updateAddress(this.address).subscribe(element1 => {
        this.service.message("Fornecedor "+this.fornecedor.name+" foi atualizado com sucesso!", "Dismiss", "success", 3000)
